...
@MappedSuperclass //Defining the class as a persistent entity allowing the hibernate API to interact with it
...
public abstract class AccountBaseUser {
	...
	//we can use for locking for thread safety @Version
    //@Column(name="OPTLOCK")
	//Instance Variables:
	...
	protected int id;	
	protected String username;	//user name of the user or librarian's account.
	protected String firstName;			//first name of the user or librarian.
	protected String lastName;				//last name of the user or librarian.
	protected int telephone;				//telephone number of the user or librarian.
	protected String address;				//address of the user or librarian.
	protected String profileImagePath;		//image path of the account's profile picture.
